...
import { getAllDishes, cuisineTypes, dietaryOptions } from "@/lib/data";
...
export default function BrowseDishesPage() {
  ...
  const filteredDishes = useMemo(() => {
    ...
    return result;
  }, [allDishes, selectedCuisine, selectedDietary, priceRange, searchQuery]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="text-stone-500 max-w-xl">
            Explore home-cooked dishes from all our cooks. Filter by cuisine,
            dietary needs, or price to find your perfect meal.
          </p>
        </div>
