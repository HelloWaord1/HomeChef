...
import { cooks, events } from "@/lib/data";
import {
  Search,
  ChefHat,
  CalendarPlus,
...
export default function HomePage() {
  const featuredCooks = cooks.filter((c) => c.verified).slice(0, 3);
  const recentEvents = events.filter((e) => e.status === "open").slice(0, 3);
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="max-w-xl">
              ...
              <p className="text-lg text-stone-500 leading-relaxed mb-8 animate-fade-in-up animation-delay-100">
                Post your event — dinner party, birthday, date night — and let
                talented home cooks bid to make it unforgettable. Or browse
                cooks directly and hire your favorite.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 animate-fade-in-up animation-delay-200">
                ...
                <Link href="/cooks" className="flex-1 sm:flex-none">
                  <Button
                    variant="outline"
                    className="w-full sm:w-auto h-12 px-6 rounded-xl border-stone-300 text-sm font-semibold"
                  >
              ...
              <div className="flex items-center gap-4 mt-8 animate-fade-in-up animation-delay-300">
                ...
                <div className="text-sm">
                  ...
                  <span className="text-stone-500">
                    Trusted by <strong className="text-stone-700">5,000+</strong>{" "}
                    hosts &amp; cooks
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="rounded-2xl overflow-hidden shadow-2xl shadow-stone-900/10 animate-fade-in-up animation-delay-200">
                    <Image
                      src="https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=400&h=500&fit=crop"
                  ...
                  <div className="rounded-2xl overflow-hidden shadow-xl animate-fade-in-up animation-delay-400">
                    <Image
                      src="https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400&h=280&fit=crop"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-stone-900 mt-3 mb-4">
              From idea to feast in three steps
            </h2>
            <p className="text-stone-500 max-w-lg mx-auto">
              Whether you&apos;re planning a dinner party for 4 or a celebration
              for 40, we make it effortless.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Describe what you need — cuisine, date, guests, budget. Our cooks will compete to win your event.",
                accent: "warm",
              },
              {
                icon: MessageSquare,
                title: "Review Bids",
                description:
                  "Cooks send proposals with their menu ideas and pricing. Compare profiles, reviews, and pick your favorite.",
                accent: "sage",
              },
              {
                icon: Handshake,
                ...
                description:
                  "Your cook handles everything. Sit back, enjoy restaurant-quality food at home, and leave a review.",
                accent: "cream",
              },
            ].map((step, i) => (
              <div key={i} className="text-center group">
                <div className="relative mb-6 inline-flex">
                  ...
                  <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-stone-900 text-white text-xs font-bold flex items-center justify-center">
                    {i + 1}
                  </span>
                </div>
          ...
          <div className="mt-12 text-center">
            ...
            <Link href="/cooks">
              <Button
                variant="outline"
                className="rounded-full border-stone-200 text-sm"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-stone-900 mt-3">
                People are looking for cooks
              </h2>
              <p className="text-stone-500 mt-2">
                Open events waiting for cook bids. Are you a cook?{" "}
                <Link
                  href="/for-cooks"
            ...
            <Link
              href="/events"
              className="hidden sm:flex items-center gap-1 text-sm font-medium text-warm-700 hover:text-warm-800 transition-colors"
            >
              View all events
          ...
          <div className="mt-8 text-center sm:hidden">
            <Link href="/events">
              <Button
                variant="outline"
                className="rounded-full border-warm-200 text-warm-700"
              >
                View all events
            ...
            {[
              {
                ...
                description:
                  "Every cook is vetted. Reviews, ratings, and verified experience you can trust.",
              },
              {
                icon: CreditCard,
                title: "Flexible Payment",
                description:
                  "Pay through the app or arrange directly. Fiat and crypto accepted.",
              },
              {
                icon: Globe,
                title: "Global Cuisines",
                description:
                  "Georgian, Japanese, Mexican, French — 200+ cuisines from 10+ countries.",
              },
              {
                icon: Users,
                title: "Any Occasion",
                description:
                  "Dinner for 2 or a party for 50. Cooks who specialize in events of every size.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="bg-white rounded-2xl p-6 border border-sage-100 hover:shadow-md transition-all"
              >
                <div className="w-11 h-11 rounded-xl bg-sage-100 text-sage-600 flex items-center justify-center mb-4">
                  <item.icon className="w-5 h-5" />
                </div>
                <h3 className="font-semibold text-stone-900 mb-1.5 text-sm">
                  {item.title}
                </h3>
      ...
      <section className="py-24 bg-gradient-to-br from-warm-700 to-warm-900 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-warm-200 text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of hosts who&apos;ve discovered the magic of hiring a
            home cook. Post your first event in under a minute.
          </p>
