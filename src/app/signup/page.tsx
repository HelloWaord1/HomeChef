      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <Card className="border-stone-200/60 shadow-lg shadow-stone-200/30">
          <CardHeader className="text-center pb-2">
            <CardTitle className="text-xl font-semibold text-stone-900">Create an account</CardTitle>
            <CardDescription className="text-stone-500">
              Start discovering amazing home-cooked meals
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-4">
            ...
            <p className="mt-4 text-center text-xs text-stone-400 leading-relaxed">
              ...
              <span className="underline cursor-pointer hover:text-stone-500">Terms of Service</span> and{" "}
              <span className="underline cursor-pointer hover:text-stone-500">Privacy Policy</span>.
            </p>
          </CardContent>
        </Card>
      </div>
